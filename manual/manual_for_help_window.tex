...
\section{Features}
    ...
    \subsection{"No zero part"}
        ...
        \begin{figure}[h]
            \centering
            \scalebox{0.45}{\includegraphics{no_zero_part.eps}}
    ...
    \subsection{"Continue the calculating"}
        ...
        \begin{figure}
            \centering
            \scalebox{0.45}{\includegraphics{continue_the_calculating01-02.eps}}
    ...
    \subsection{"Change the operation sign"}
        ...
        \begin{figure}[h]
            \centering
            \scalebox{0.45}{\includegraphics{change_the_operation_sign.eps}}
    ...
    \subsection{In-build user manual}
        ...
        \begin{figure}[h]
            \centering
            \scalebox{0.35}{\includegraphics{help_window.eps}}
